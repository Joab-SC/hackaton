defmodule Hackaton.Adapter.Mensajes.ManejoMensajes do
  ...
  def chatear(actual, otro, extra, funcion_crear_mensajes_atomo, funcion_obtener_mensajes_atomo, funcion_obtener_mensajes_pendientes_atomo) do
    case NodoCliente.ejecutar(funcion_obtener_mensajes_atomo, [
           "lib/hackaton/adapter/persistencia/mensaje.csv",
           otro.id,
           actual.id,
    ...
    tarea = Task.async(fn -> lector(otro, actual, extra, funcion_obtener_mensajes_pendientes_atomo) end)
